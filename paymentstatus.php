    ...
    <li><a href="index.php">Logout</a></li>
      ...
      <div class="col-md-3">
        <div class="list-group">
          <a href="" class="list-group-item active" style="background-color:#3498DB;color:#ffffff;border-color:#3498DB">Appointments</a>
          ...
          <a href="" class="list-group-item">Doctor Section</a>
